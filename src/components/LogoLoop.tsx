...
export interface LogoLoopProps {
  ...
  renderLogoItem?: (item: LogoItem, index: number) => React.ReactNode;
}
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const defaultRenderLogoItem = useCallback((item: LogoItem, key: React.Key) => {
        ...
        Array.from({ length: copyCount }, (_, copyIndex) => (
          ...
          >
            {logos.map((item, itemIndex) => {
              ...
              return defaultRenderLogoItem(item, `${copyIndex}-${itemIndex}`);
            })}
          </ul>
        )),
      [copyCount, logos, renderLogoItem, defaultRenderLogoItem]
    );
