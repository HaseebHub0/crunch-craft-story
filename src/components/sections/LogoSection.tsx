...
const LogoSection = () => {
  ...
  // Convert image paths to LogoLoop format
  ...
  // Custom renderer to maintain the existing design
  const renderCustomLogo = (item: any, index: number) => (
        ...
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div className="py-4">
            <LogoLoop
              ...
              scaleOnHover
              fadeOut
              fadeOutColor="hsl(45 100% 97%)" // amber-50
              ariaLabel="Product logos"
              className="custom-logo-loop"
              renderLogoItem={renderCustomLogo}
            />
          </div>
        </div>
      </div>
