  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white font-poppins font-semibold shadow-elegant hover:shadow-glow hover:scale-105 transform transition-all duration-300 border-0",
        premium: "bg-white text-primary border-2 border-primary hover:bg-primary hover:text-white shadow-floating hover:shadow-elegant transform hover:scale-105 transition-all duration-300",
